...
SELECT venda_id, produto_id, valor_unitario, data_venda FROM vendas_itens WHERE produto_id = 2 ORDER BY data_venda DESC;

SELECT venda_id, produto_id, valor_unitario, valor_unitario * 1.10 AS valor_venda  FROM vendas_itens WHERE venda_id = 2001 ORDER BY valor_unitario ASC;

SELECT venda_id, produto_id, valor_unitario, valor_unitario * 1.10 AS valor_venda  FROM vendas_itens  ORDER BY valor_unitario ASC;

-- buscar valores unitarios 

SELECT * FROM vendas_itens WHERE valor_unitario >= 50 AND valor_unitario <= 100 ORDER BY valor_unitario ASC;


SELECT * FROM vendas_itens WHERE valor_unitario < 20 OR valor_unitario > 200 ORDER BY valor_unitario ASC;
